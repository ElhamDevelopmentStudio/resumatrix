...
export function OptimizerCard() {
  return (
    <Card className="relative col-span-1 gap-0 overflow-hidden border-0 bg-gradient-to-br from-primary to-tertiary p-6 text-primary-foreground shadow-lg lg:col-span-2">
      <div className="relative z-10 max-w-[280px]">
        ...
        <Button
          type="button"
          variant="secondary"
          className="mt-6 h-auto bg-card px-6 py-2.5 text-sm font-bold text-primary shadow-md hover:bg-card/90"
        >

...
const convexFunctions = {
  careerData: {
    getWorkspace: makeFunctionReference("career_data:getWorkspace"),
    setPersonal: makeFunctionReference("career_data:setPersonal"),
    createContact: makeFunctionReference("career_data:createContact"),
    deleteContact: makeFunctionReference("career_data:deleteContact"),
    createExperience: makeFunctionReference("career_data:createExperience"),
    deleteExperience: makeFunctionReference("career_data:deleteExperience"),
    createProject: makeFunctionReference("career_data:createProject"),
